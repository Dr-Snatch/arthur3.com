...
headline: "A real-time AI game engine that turns unreliable model output into resilient game state."
...
That same extraction pipeline now informs other work on the site, especially the notes around prompt design and local-model benchmarking.
