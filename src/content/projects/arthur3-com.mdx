...
headline: "Developer portfolio · Astro + React Islands · Interactive Terminal · Keystatic CMS · Cloudflare Pages · WCAG 2.1 AA"
problem: "Most portfolio sites list tools but fail to explain what problems the developer can solve."
system: "Astro site with a React terminal island, file-backed content collections, and Cloudflare deployment through Keystatic."
result: "A content-driven portfolio that doubles as a case-study site and can be updated through code or CMS."
status: in-progress
featured: false
...
| Metric | Result |
|--------|--------|
| Homepage weight | 18KB HTML + CSS (0KB JS by default) |
| LCP (mobile) | Under 1s on 4G |
| Accessibility | WCAG 2.1 AA — skip links, ARIA labels, keyboard nav |
| CMS | Git-backed Markdown via Keystatic — no vendor lock-in |
